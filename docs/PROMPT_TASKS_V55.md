...
> (B91); falta a projeção semântica e o leitor Rust. Reuse as provas já validadas.
...
- Trabalhe na worktree já existente `F:/Python_C_Projects/PWSource1.5.3/pw-126`,
  ...
  Último HEAD conhecido: a305e51. B89/B90 podem estar sem commit: preserve tudo.
...
- Não declarar missões jogáveis: listas TASK_DATA/TASK_VAR_DATA e integração em jogo
  ficam para a retomada. B90 só corrigiu pacotes de itens/experiência.
...
Branch/HEAD: ...; mudanças anteriores B89/B90 preservadas: ...
