...
(`.Codex/settings.json` → `.Codex/agents/pw-server-dev.md`). Se por algum motivo ele não
...
sobre fato falso. Um hook de fim de turno (`.Codex/hooks/lembrar_specs.sh`) cobra isso
