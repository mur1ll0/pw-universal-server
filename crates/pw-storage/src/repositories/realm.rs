...
pub struct RealmRecord {
    ...
    pub is_online: bool,
    pub max_players: i32,
    pub double_exp_multiplier: sqlx::types::BigDecimal,
    pub double_sp_multiplier: sqlx::types::BigDecimal,
    pub double_drop_multiplier: sqlx::types::BigDecimal,
    pub double_gold_multiplier: sqlx::types::BigDecimal,
