...
/// Encodifica uma estrutura RoleInfo na versão 1.2.6 (19 campos, sem referrer_role, cash_add, etc.)
pub fn encode_role_info_126(stream: &mut OctetsStream, c: &CharacterSummary) {
    ...
    // No 1.2.6 termina aqui: 19 campos.
}
