...
pub struct V148Protocol(pub V155Protocol);

impl std::ops::Deref for V148Protocol {
    type Target = V155Protocol;
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}

impl WorldProtocol for V148Protocol {
    ...
    fn player_info_00(
        ...
        self.0.player_info_00(player_id, level, level2, hp, max_hp, mp, max_mp, alvo)
    }
    ...
    fn inst_data_checkout(
        ...
        // 1.4.8 tem os 5 timestamps clássicos sem gshop3
        crate::packets::s2c::S2CGamedataSend::inst_data_checkout(id_inst, region, precinct, gshop, gshop2)
    }
...
pub struct V148Adapter;

impl ProtocolAdapter for V148Adapter {
    fn version(&self) -> GameVersion {
        GameVersion::V1_4_8
    }
